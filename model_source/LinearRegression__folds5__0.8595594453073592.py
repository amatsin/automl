...
for fold_, (trn_, val_) in enumerate(folds.split(y, y)):
    ...
    clf = LinearRegression().fit(trn_x, trn_y)
...
Path('../model_predictions').mkdir(exist_ok=True)
sample.to_csv('../model_predictions/submission_{}__{}.csv'.format(MODEL_NAME, str(roc_score)), index=False)
